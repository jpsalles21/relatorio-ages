\begin{resumo}[\protect\bfseries Resumo]
    ...
    pré-triagem de pacientes em ensaios clínicos. Na AGES III, meu foco foi a arquitetura e integração no projeto
    ...
    organização do trabalho do time. Ao longo dessas etapas, percebi que para se tornar um Engenheiro de Software qualificado não posso depender

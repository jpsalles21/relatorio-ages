...
\subsection{Banco de Dados Utilizado}
  O banco de dados principal escolhido para o projeto foi o MongoDB Atlas \cite{mongodbatlas}. A decisão fez sentido para o nosso contexto porque o produto precisava lidar com conteúdos variados e com possibilidade de evolução frequente, como informações de edificações, materiais multimídia e dados administrativos.
...
\begin{figure}[H]
    ...
    \vspace{-0.5em}
    \includegraphics[trim=20 60 20 60,clip,height=0.30\textheight,keepaspectratio]{conteudo/5 - ages IV/conteudo/figures/DiagramaBancoUmaPortoAlegreAlema.png}\\[-0.2em]
...
\subsection{Arquitetura Utilizada}
  ...
  Em termos de fluxo, o usuário acessava o \textit{frontend} no navegador, que enviava requisições para a \ac{api}. O \textit{backend} processava essas requisições e, quando necessário, consultava o MongoDB, manipulava arquivos no \ac{s3} e buscava segredos no Secrets Manager. Depois disso, a resposta retornava ao \textit{frontend} para exibição ao usuário final. A Figura~\ref{fig:arquitetura-ages-iv} registrou a organização planejada para essa arquitetura. Como a solução final ainda não estava implementada naquele momento, seguimos com a arquitetura planejada para garantir que o desenvolvimento ficasse alinhado com as necessidades do projeto e dos \textit{stakeholders}.

\enlargethispage{3\baselineskip}
\begin{figure}[H]
    \centering
    \small
    \caption{Diagrama C4 de contêineres do projeto - AGES IV}
    \vspace{-0.5em}
    \includegraphics[height=0.28\textheight,keepaspectratio]{conteudo/5 - ages IV/conteudo/figures/arquitetura-c4-containers-agesIV.pdf}\\[-0.2em]
...
\begin{figure}[H]
    ...
    \vspace{-0.5em}
    \includegraphics[height=0.56\textheight,keepaspectratio]{conteudo/5 - ages IV/conteudo/figures/LandingPage.png}\\[-0.2em]
